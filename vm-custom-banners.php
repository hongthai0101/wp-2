<?php
/*
Plugin Name: VietMoney Override Custom Banners
Plugin Script: vm-custom-banners.php
...
class CustomBannersPlugin extends CBP_GoldPlugin
{
	...
	function create_post_types()
	{
		...
		$customFields = array();
        //$customFields[] = array('name' => 'title', 'title' => 'Title', 'type' => 'text');
		$customFields[] = array('name' => 'target_url', 'title' => 'Target URL', 'type' => 'text');
		$customFields[] = array('name' => 'description', 'title' => 'Slider description', 'type' => 'text');
		$customFields[] = array('name' => 'order', 'title' => 'Slier order', 'type' => 'number');
	...
	function custom_banners_unused_meta() {
        ...
        //remove_post_type_support( 'banner', 'thumbnail' );
        remove_post_type_support( 'banner', 'editor' );
        //remove_post_type_support( 'banner', 'title' );
	}
